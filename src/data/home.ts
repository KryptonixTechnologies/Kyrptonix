export const stats = [
  ...
  { value: "P0", label: "lead generation focus" },
];

export const differentiators = [
  {
    title: "End-to-end capability",
    description: "Strategy, software, infrastructure, cloud, security, and support under one roof.",
  },
  {
    title: "Local expertise, global standards",
    description: "Built for African business realities while following modern engineering practices.",
  },
  {
    title: "Clear delivery process",
    description: "Discovery, design, development, deployment, and continuous support without mystery.",
  },
  {
    title: "Security-first thinking",
    description: "Every solution is planned with privacy, resilience, access control, and monitoring in mind.",
  },
];
...
export const partners = ["Microsoft", "Google Cloud", "AWS", "Cloudflare", "HubSpot", "Zoho"];
